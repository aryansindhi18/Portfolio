...
export function TopBar(){
    ...
    return <div className="bg-[#fafafa] fixed top-0 left-0 w-full z-50 shadow h-14 flex justify-between px-4 py-8">
        ...
        <div className="flex items-center mr-4">
            ...
            {/* <button onClick={() => window.open('https://drive.google.com/file/d/1kRc1AsaXHDoAafK7uki1AI6FjAGH1gtt/view?usp=sharing', '_blank')} className="bg-blue-500 hover:bg-blue-700 text-white font-bold mx-2 py-2 px-4 rounded">
                View Resume
            </button> */}
            <div className="flex items-center mr-4">
